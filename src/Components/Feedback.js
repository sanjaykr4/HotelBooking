                    ...
                    <div className="feedback">
                        <section id="contact">
                            <div className="section-content">
                                <h1 className="section-header">Get in <span className="content-header wow fadeIn " > Touch with us</span></h1>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-4">
                                                <div className="col-md-12">
                                                    ...
                                                    <div>
                                                        <button type="button" className="btn btn-success submit"> Send Message</button>
                                                    </div>
                                                </div>
                                            </div>
